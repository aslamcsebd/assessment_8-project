...
@section('content')
    <div class="container">
        ...
        <style>
            ...
            .col-4 tr td:nth-child(2),
            .col-4 tr td:nth-child(3) {
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if (isset($gameStart))
                            <a href="{{ Route('gameDelete') }}" class="btn btn-sm btn-danger text-light float-right">Delete
                                game</a>
                        @else
                            <button class="btn btn-sm btn-success text-light float-right" data-toggle="modal"
                                data-original-title="test" data-target="#gameEntry">Start new game</button>
                        @endif
                    </div>
...
<div class="modal fade" id="gameEntry" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h]]]]]]]
                \ class="modal-title pl-2" id="exampleModalLabel">Add information</h>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body py-0">
                <form action="{{ Route('gameEntry') }}" method="post" enctype="multipart/form-data"
                    class="needs-validation">
                    @csrf
                    <div class="row">
                        <div class="form-group col-4">
                            <label>First player :</label>
                            <input class="form-control" name="firstPlayer" value="{{ Auth::user()->name }}"
                                type="text" placeholder="{{ Auth::user()->name }}" readonly>
                        </div>
                        <div class="form-group col-4">
                            <label for="secondPlayer">Second player :</label>
                            <input name="secondPlayer" class="form-control" id="secondPlayer" type="text"
