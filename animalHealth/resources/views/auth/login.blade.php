      ...
      <div class="col-md-6">
         <div class="card mt-5">
            <div class="text-center pt-2">
                ...
                @endphp               
               <img src="{{ ($setting->logo) ?? asset('default.jpg') }}" class="img-thumbnail" alt="No Image found" width="100">
               <br>
               <h4>{{ $setting->name ?? 'Add company name' }}</h4>
         ...
         <div class="card-body">
            <form method="POST" action="{{ route('login') }}">
               ...
               <div class="form-group row mb-0">
                     <button type="submit" class="btn btn-sm btn-primary px-3 col-md-6 offset-md-4">
                        {{ __('Sign in') }}
                     </button>
               </div>
            </form>
