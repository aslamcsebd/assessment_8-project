...
<body class="container-fluid row justify-content-center mt-5">
    <?php
        $result = file_get_contents('discount.json');
        $discount = json_decode($result, true);
    ?>
    <table class="table table-bordered text-center text-light col-md-5">
        <thead class="bg-info">
            <th>Sl</th>
            <th>Min</th>
            <th>Max</th>
    ...
    <table class="table table-bordered w-auto col-md-5 ml-3">
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-primary minus py-0 rounded">-</button>
                    <input type="number" class="count text-center" name="qty" value="1">
                    <button type="button" class="btn btn-secondary py-0 plus rounded">+</button>
                </td>
            </tr>
        </tbody>
    </table>
